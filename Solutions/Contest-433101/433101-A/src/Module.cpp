...
public:
    //-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
    /// Custom Deleter for concrete I_Solution implementations that originate
    /// from this module.
    struct Deleter
    {
        void
        operator()(I_Solution* _pSolution)
        {
            Solution* pSolution =
                dynamic_cast<Solution*>(_pSolution);
...
extern "C"
SOLUTION_DLL_LINK
GCJFramework::I_Module&
getModule()
{
    return GCJFramework::Module::instance();
}
