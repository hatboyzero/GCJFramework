...
set(BoostVersion 1.56.0)
set(BoostSHA1 f94bb008900ed5ba1994a1072140590784b9b5df)
...
if(NOT IS_DIRECTORY "${BoostCacheDir}")
  if(BOOST_CACHE_DIR)
    ...
    set(Message "${Message}  Falling back to default path at \"${CMAKE_BINARY_DIR}/GCJFramework\"\n")
    message(WARNING "${Message}")
  endif()
  set(BoostCacheDir ${CMAKE_BINARY_DIR})
else()
  if(NOT USE_BOOST_CACHE AND NOT BOOST_CACHE_DIR)
    set(BoostCacheDir "${BoostCacheDir}/GCJFramework")
  endif()
...
if(WIN32)
  ...
  if(${BoostSourceDirLength} GREATER 130)
    ...
    set(Msg "${Msg}  mkdir C:\\GCJFramework_boost\n")
    set(Msg "${Msg}  cmake . -DUSE_BOOST_CACHE=ON -DBOOST_CACHE_DIR=C:\\GCJFramework_boost\n\n")
...
install(DIRECTORY ${BoostSourceDir}/boost DESTINATION include/GCJFramework/external)